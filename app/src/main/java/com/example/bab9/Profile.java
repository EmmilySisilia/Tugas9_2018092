...
import com.example.bab9.databinding.ProfileBinding;
...
//for view display
        binding.btnDisplay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Profile.this, com.example.bab9.DisplayData.class));
            }
        });
...
//edit hide and submit visible
                    ...
                    Intent a = new Intent(Profile.this, com.example.bab9.DisplayData.class);
                    startActivity(a);
                }
            }
        });
